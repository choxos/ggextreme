...
- Meta-analysis: forest plots with
...
- Trials and survival: Kaplan-Meier plots with
  [`ggkm()`](https://choxos.github.io/ggextreme/reference/ggkm.md) and
...
- Explorers:
  ...
  for unmeasured confounding and
  [`ggmultiverse()`](https://choxos.github.io/ggextreme/reference/ggmultiverse.md)
  for a multiverse of analyses.
- Nomograms of regression models with
